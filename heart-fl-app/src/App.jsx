...
export default function App() {
  ...
  return (
    ...
    >
      {user.role === 'admin' && renderAdminPage(currentPage, { selectedHospitalId, handleViewHospital, setCurrentPage })}
...
function renderAdminPage(page, { selectedHospitalId, handleViewHospital, setCurrentPage }) {
  switch (page) {
    case 'dashboard':
